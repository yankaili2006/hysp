...
$(document).ready(function() {
		...
		$("#admin_pageconset").append("<div class='pageconsetitem'>容器宽度：<select id='pagecontainwidth' ><option value='1002'>默认(1002PX)</option><option value='900'>中幅(900PX)</option><option value='950'>中幅(950PX)</option><option value='990'>宽幅(990PX)</option><option value='1258'>超宽(1258PX)</option><option value='1418'>超宽(1418PX)</option><option value='1658'>超宽(1658PX)</option><option value='850'>窄幅(850PX)</option><option value='780'>窄幅(780PX)</option><option value='600'>名片(600PX)</option></select></div>");
