...
//curl_setopt($this->ch, CURLOPT_CAINFO, 'f:\php-4.3.2-win32\extensions\curl-ca-bundle.crt');		
	...
	* @access   public
	*/
	function send($data, $timeout=0, $response_timeout=180) {
	...
	* @access   public
	*/
	function sendHTTPS($data, $timeout=0, $response_timeout=180) {
...
class wsdl extends nusoap_base {
     ...
     * @access public 
     */
    function wsdl($wsdl = '',$proxyhost=false,$proxyport=false,$proxyusername=false,$proxypassword=false,$timeout=0,$response_timeout=180){
        $this->wsdl = $wsdl;
...
class soapclientx extends nusoap_base  {
	...
	* @access   public
	*/
	function soapclientx($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 180){
